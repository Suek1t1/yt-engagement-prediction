...
p=dict(objective="regression_l1",metric="l1",n_estimators=1500,learning_rate=0.05,num_leaves=47,
...
np.save(f"likes_model/oof_l1_idx_{fold}.npy",va);np.save(f"likes_model/oof_l1_pred_{fold}.npy",pred)
